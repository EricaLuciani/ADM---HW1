...
- Luciani_HMW 1 - Problem 1.pdf, a pdf containing the screenshots of the page 'Submissions' from HackerRank
- Luciani_HMW 1 - Problem 2.ipynb, a file that contains any solution of the exercises from Problem 2 that I completed
- Luciani_HMW 1 - Problem 2.pdf, a pdf containing the screenshots of the page 'Submissions' from HackerRank
